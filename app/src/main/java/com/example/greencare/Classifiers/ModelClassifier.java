...
import static com.example.greencare.Classifiers.Configuration.IMAGE_STD;
...
public class ModelClassifier {
    ...
    //Returns the sorted results arraylist which are prediction label and the confidence level
